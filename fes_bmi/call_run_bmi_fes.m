...
emg_list_4_dec          = {'FCRu', 'FCUu', 'FDPr', 'FDPu', 'FDSr', 'FDS', 'PL'};
...
sp.EMG_to_stim_map      = [{'FCRu', 'FCUu', 'FDPr', 'FDPu', 'FDSr', 'FDS', 'PL'}; ...
                            {'FCRu', 'FCUu', 'FDPr', 'FDPu', 'FDSr', 'FDSu', 'PL'}];
...
%     file4decoder        = 'E:\Data-lab1\TestData\_to_delete\datafile002.nev'
    file4decoder        = 'E:\Data-lab1\12A1-Jango\CerebusData\BMI-FES\20160313\Jango_MG_PG_20160313_T3_003.nev';
end
...
%        sp.muscles                  = {'FCRu', 'FCUu', 'FDPr', 'FDPu', 'FDSr', 'FDSu'};
        sp.muscles                  = {'FCRu', 'FCUu', 'FDPr', 'FDPu', 'FDSr', 'FDSu', 'PL' };
...
%                                         { 1, 1, 1, 1, 1, 1 }];
                sp.anode_map        = [{ 1, 3, 5, 7, 9, 13, 15 }; ...
                                        { 1, 1, 1, 1, 1, 1, 1 }];
                % define the cathodes; empty for bipolar
                if strcmp(stim_mode,'bipolar')
%                     sp.cathode_map  = [{ 2, 4, 8, 10, 12, 14 }; ...
%                                         { 1, 1, 1, 1, 1, 1,  }];
                    sp.cathode_map  = [{ 2, 4, 6, 8, 10, 14, 16 }; ...
                                        { 1, 1, 1, 1, 1, 1, 1 }];
                elseif strcmp(stim_mode,'monopolar')
                    sp.cathode_map  = {{ }};
                end
...
sp.EMG_min              = [.3 .1 .1 .1 .1 .1 .1];
sp.EMG_max              = [.9 .7 .8 .8 .8 .8 .8];
        
sp.PW_min               = [.05 .05 .05 .05 .05 .05 .05]; % repmat( 0.05, 1, numel(sp.muscles));
