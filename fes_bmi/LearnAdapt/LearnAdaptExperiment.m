...
% IP address: 0:10 are the last two numbers
 ...
 %if udp echo already in port, type: echoudp('off');
...
params.n_emgs=length(emg_vector);

% 5. 
params.neuron_decoder = N2E;
params.emg_decoder = E2F; % Normal Decoder
% params.emg_decoder = E2F_reflected; % Reflected Decoder
...
% UNCHECK 900 seconds of recording
% turn off TimeToRecord
