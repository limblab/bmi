%
% Function to test the latency when updating the PW of several channels in
% Ripple's wireless stimulator. Those PW values are randomly generated by
% the function. Pulses are always bipolar with both phases having the same
% duration.
%
